  ...
  return (
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SectionHeading className="mt-4">Connects with your entire stack</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Cognify plugs into the tools your team already uses —
          no custom middleware, no re-architecture required.
        </SubHeading>

        <div className="mt-8 flex flex-wrap justify-center gap-4 text-xs font-mono font-medium text-neutral-500 dark:text-neutral-400 select-none px-4">
          {["Slack", "Notion", "Google Sheets", "AWS S3", "Stripe", "GitHub", "PostgreSQL", "Redis"].map((logo) => (
            <span key={logo} className="px-3 py-1.5 rounded-md border border-gray-200 dark:border-neutral-800 bg-gray-50/50 dark:bg-neutral-900/40 hover:text-brand hover:border-brand/30 transition-all duration-200">
              {logo}
            </span>
          ))}
        </div>
